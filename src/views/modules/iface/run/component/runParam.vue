...
-->
          ...
          <!--
            ...
            <expand ref="header" >
               ...
               <runheader  v-show="!headerRawShow"  :item="item"></runheader>
        ...
        <el-row class="row">
            ...
            <template v-if="resultType==1">
                <el-row class="row" style="padding: 10px 10px 10px 20px;margin-bottom: 10px" key="real">
                    ...
                    <el-button size="mini" type="text" style="font-size: 15px"  icon="el-icon-info" v-if="errorCount>0">
                    </el-button>
                </el-row>
...
<script>
 ...
 import ellc from './ellc.vue'

 import expand from '@/components/expand.vue'

 //   var runBody=require("./runBody.vue")
 //import runRestParam from './runRestParam.vue'
